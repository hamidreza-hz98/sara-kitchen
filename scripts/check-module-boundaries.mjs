...
export const dependencyMap = Object.freeze({
  addresses: ["customers", "logs"],
  admins: ["logs"],
  analytics: ["customers", "dishes", "logs", "orders"],
  auth: ["admins", "customers", "logs", "sessions"],
  blogs: ["admins", "dishes", "logs", "media"],
  carts: ["addresses", "customers", "dishes", "logs"],
  categories: ["logs", "media"],
  contacts: ["logs"],
  customers: ["logs"],
  dishes: ["categories", "ingredients", "logs", "media"],
  ingredients: ["logs", "media"],
  logs: [],
  media: ["logs"],
  orders: ["addresses", "carts", "customers", "dishes", "logs", "transactions"],
  seo: ["blogs", "categories", "dishes", "logs", "media"],
  sessions: ["logs"],
  settings: ["blogs", "categories", "dishes", "logs", "media"],
  transactions: ["customers", "logs"],
});
